...
DECLARE_FT_BITMAP_ROTATE_INIT_90(2);

DECLARE_FT_BITMAP_ROTATE_INIT_4_90(2)
{
...
DECLARE_FT_BITMAP_ROTATE_INIT_4_ITALIC_90(2)
{
    return 0;
}

DECLARE_FT_BITMAP_ROTATE_INIT_4_BOLD_90(2)
{
    return 0;
}

DECLARE_FT_BITMAP_ROTATE_DST_COORDS_90(2)
{
...
DECLARE_FT_BITMAP_ROTATE_ITALIC_ACTION_90(2)
{
    if (to_bottom)
    {
        FT_Bitmap_Italic_Ver(pDst, degree, to_bottom, oblique, pSrc, slot, pPixelFuncs);
    }
    else
    {
        FT_Bitmap_Italic_Hor(pDst, degree, to_bottom, oblique, pSrc, slot, pPixelFuncs);
    }
    return 0;
}
