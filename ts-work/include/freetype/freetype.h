...
#define FT_CHECK_POSTURE_TO_BOTTOM(flags)             (flags & FT_POSTURE_TO_BOTTOM)

/**
 The width of bold font is larger then normal.
 In office style, this change is not needed.
 */
#define FT_SOLID_SIZE_DISABLE                          0
#define FT_SOLID_SIZE_ENABLE                          (0x01 <<  1)
#define FT_CHECK_CHANGE_SIZE_ENABLE(flags)           !(flags & FT_SOLID_SIZE_ENABLE)

#define FT_SOLID_SIZE_X_DISABLE                        0
#define FT_SOLID_SIZE_X_ENABLE                        (0x01 <<  2)
#define FT_CHECK_CHANGE_SIZE_X_ENABLE(flags)         !(flags & FT_SOLID_SIZE_X_ENABLE)

#define FT_SOLID_SIZE_Y_DISABLE                        0
#define FT_SOLID_SIZE_Y_ENABLE                        (0x01 <<  3)
#define FT_CHECK_CHANGE_SIZE_Y_ENABLE(flags)         !(flags & FT_SOLID_SIZE_Y_ENABLE)

/**
 * Slot tunning.
 */
#define FT_BITMAP_SLOT_TUNING_DISABLE                  0
#define FT_BITMAP_SLOT_TUNING_ENABLE                  (0x01 <<  4)
#define FT_CHECK_BITMAP_SLOT_TUNING(flags)            (flags & FT_BITMAP_SLOT_TUNING_ENABLE)

/**
 * Gray bold. 4 directions all.
 */
#define FT_BITMAP_BOLD_GRAY_DISABLE                    0
#define FT_BITMAP_BOLD_GRAY_ENABLE                    (0x01 <<  5)
#define FT_CHECK_BITMAP_BOLD_GRAY(flags)              (flags & FT_BITMAP_BOLD_GRAY_ENABLE)

#define FT_BITMAP_BOLD_GRAY_NORTH_DISABLE              0
#define FT_BITMAP_BOLD_GRAY_NORTH_ENABLE              (0x01 <<  6)
#define FT_CHECK_BITMAP_BOLD_GRAY_NORTH(flags)        (flags & FT_BITMAP_BOLD_GRAY_NORTH_ENABLE)

#define FT_BITMAP_BOLD_GRAY_EAST_DISABLE               0
#define FT_BITMAP_BOLD_GRAY_EAST_ENABLE               (0x01 <<  7)
#define FT_CHECK_BITMAP_BOLD_GRAY_EAST(flags)         (flags & FT_BITMAP_BOLD_GRAY_EAST_ENABLE)

#define FT_BITMAP_BOLD_GRAY_SORTH_DISABLE              0
#define FT_BITMAP_BOLD_GRAY_SORTH_ENABLE              (0x01 <<  8)
#define FT_CHECK_BITMAP_BOLD_GRAY_SORTH(flags)        (flags & FT_BITMAP_BOLD_GRAY_SORTH_ENABLE)

#define FT_BITMAP_BOLD_GRAY_WEST_DISABLE               0
#define FT_BITMAP_BOLD_GRAY_WEST_ENABLE               (0x01 <<  9)
#define FT_CHECK_BITMAP_BOLD_GRAY_WEST(flags)         (flags & FT_BITMAP_BOLD_GRAY_WEST_ENABLE)

#define FT_FLIP_L2R_DISABLE                            0
#define FT_FLIP_L2R_ENABLE                            (0x01 << 10)
#define FT_CHECK_FLIP_L2R(flags)                      (flags & FT_FLIP_L2R_ENABLE)

#define FT_FLIP_T2B_DISABLE                            0
#define FT_FLIP_T2B_ENABLE                            (0x01 << 11)
#define FT_CHECK_FLIP_T2B(flags)                      (flags & FT_FLIP_T2B_ENABLE)
 ...
 */
#define FT_BITMAP_RIGHT_ANGLE_ENABLE
...
#define ft_open_params    FT_OPEN_PARAMS
  ...
  FT_EXPORT( FT_Error )
  FT_Load_Glyph_Office( FT_Face   face,
                 FT_UInt   glyph_index,
                 FT_Int32  load_flags,
				 FT_Int32  office_flags);
